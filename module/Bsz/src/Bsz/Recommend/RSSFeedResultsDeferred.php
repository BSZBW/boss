...
/**
 * RSSFeed Recommendations Module
 *
 * This class sets up an AJAX call to trigger a call to an RSSFeed
 * module.
 *
 * @category VuFind
 * @package  Recommendations
 ...
 * @link     https://vufind.org/wiki/development:plugins:recommendation_modules Wiki
 */
class RSSFeedResultsDeferred implements \VuFind\Recommend\RecommendInterface
{
    /**
    ...
    {
        return 'mod=RSSFeedResults&params=' . urlencode($this->processedParams)
